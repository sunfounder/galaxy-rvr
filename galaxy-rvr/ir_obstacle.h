...
/**
 * @brief Returns true if the left infrared obstacle avoidance sensor is
 * detected.
 *
 * @return true
 * @return false
 */
bool irObstacleIsLeftDetected();

/**
 * @brief Returns true if the right infrared obstacle avoidance sensor is
 * detected.
 *
 * @return true
 * @return false
 */
bool irObstacleIsRightDetected();
