function changeLanguage() {
    ...
    let supportLangs = {
        ...
        'ja': ['銇撱伄銉夈偔銉ャ儭銉炽儓銇?, '鏃ユ湰瑾?, '浠婂緦琛ㄧず銇椼仾銇?],
        'fr': ['Cette documentation est 茅galement disponible en', 'fran莽ais', 'Ne plus afficher'],
        'es': ['Esta documentaci贸n tambi茅n est谩 disponible en', 'espa帽ol', 'No mostrar m谩s'],
        'it': ['Questa documentazione 猫 disponibile anche in', 'Italiano', 'Non mostrare pi霉'],
        'en': ['姝ゆ枃妗ｄ篃鏈変腑鏂囩増鏈?, '涓枃', '涓嶅啀鏄剧ず']
    };
