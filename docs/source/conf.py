...
.. |download_galaxyrvr_filmware| replace:: :download:`Archivo de firmware GalaxyRVR <https://github.com/sunfounder/galaxy-rvr/releases/latest/download/galaxy-rvr.ino.zip>`
